...
<script>
    ...
    const imgAdmin = require('../../assets/img/app-navigator/app-admin.svg');
    const imgAgent = require('../../assets/img/app-navigator/app-agent.svg');
    const imgAudit = require('../../assets/img/app-navigator/app-audit.svg');
    const imgHistory = require('../../assets/img/app-navigator/app-history.svg');
    const imgSupervisor = require('../../assets/img/app-navigator/app-supervisor.svg');
    const imgGrafana = require('../../assets/img/app-navigator/app-grafana.svg');

    const CURRENT_APP = 'admin';
