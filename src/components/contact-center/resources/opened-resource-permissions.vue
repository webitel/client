...
<script>
    import rolePopup from './opened-resource-permissions-role-popup';
    import tableComponentMixin from '@/mixins/tableComponentMixin';
    import editComponentMixin from '@/mixins/editComponentMixin';
    import {mapActions, mapState} from "vuex";

    export default {
        name: "opened-resource-permissions",
        ...
        computed: {
            ...
            size: {
                get() {
                    return this.$store.state.ccenter.res.permissions.size
                },
                set(value) {
                    this.setSize(value)
                }
            ...
            search: {
                get() {
                    return this.$store.state.ccenter.res.permissions.search
                },
                set(value) {
