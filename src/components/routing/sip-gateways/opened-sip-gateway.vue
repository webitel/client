...
import { sipAccountValidator, gatewayHostValidator, ipValidator } from '../../../utils/validators';
...
export default {
  ...
  computed: {
    ...
    path() {
      const url = this.isRegister ? '/routing/gateways/register' : '/routing/gateways/trunking';
      return [
