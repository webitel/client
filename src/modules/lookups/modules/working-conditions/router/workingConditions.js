...
import WorkingConditionsRouteNamesEnum from './_internals/WorkingConditionsRouteNames.enum.js';

const WorkingConditions = () =>
	import('../components/the-working-conditions.vue');
const OpenedWorkingCondition = () =>
	import('../components/opened-working-condition.vue');

const OpenedWorkingConditionGeneral = () =>
	import('../components/opened-working-condition-general.vue');
