...
import ShiftTemplatesRouteNames from './_internals/ShiftTemplatesRouteNames.enum.js';

const ShiftTemplates = () => import('../components/the-shift-templates.vue');
const OpenedShiftTemplate = () =>
	import('../components/opened-shift-template.vue');

const OpenedShiftTemplateGeneral = () =>
	import('../components/opened-shift-template-general.vue');
const OpenedShiftTemplateTimes = () =>
	import('../components/opened-shift-template-times.vue');
