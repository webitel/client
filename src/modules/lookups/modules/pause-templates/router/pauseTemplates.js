...
import PauseTemplatesRouteNames from './_internals/PauseTemplatesRouteNames.enum.js';

const PauseTemplates = () => import('../components/the-pause-templates.vue');
const OpenedPauseTemplate = () =>
	import('../components/opened-pause-template.vue');

const OpenedPauseTemplateGeneral = () =>
	import('../components/opened-pause-template-general.vue');
const OpenedPauseTemplateCauses = () =>
	import('../components/opened-pause-template-causes.vue');
