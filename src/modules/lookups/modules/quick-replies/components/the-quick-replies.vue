      ...
      <section class="table-section">
        <header class="table-title">
          ...
          <div class="table-title__actions-wrap">
            <wt-action-bar :include="[IconAction.REFRESH, IconAction.DELETE]"
              :disabled:delete="!hasDeleteAccess || !selectedRows.length" @click:refresh="loadList" @click:delete="askDeleteConfirmation({
