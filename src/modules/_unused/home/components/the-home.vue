...
<script>
import CategoryLvl1 from '../../../start-page/components/_internals/start-category-lvl-1.vue';
import CategoryLvl2 from '../../../start-page/components/_internals/start-category-lvl-2.vue';
