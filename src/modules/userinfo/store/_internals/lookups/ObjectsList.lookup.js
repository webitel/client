...
export default Object.freeze([
  ...
  { field: 'calendars', name: AdminSections.CALENDARS, route: RouteNames.CALENDARS },                // scope: calendars
  { field: 'lookups', name: AdminSections.REGIONS, route: RouteNames.REGIONS },      // scope: lookups
  { field: 'lookups', name: AdminSections.COMMUNICATIONS, route: RouteNames.COMMUNICATIONS },      // scope: lookups
  { field: 'lookups', name: AdminSections.PAUSE_CAUSE, route: RouteNames.PAUSE_CAUSE },      // scope: lookups
  ...
  { field: 'cc_bucket', name: AdminSections.BUCKETS, route: RouteNames.BUCKETS },                    // scope: cc_bucket
  ...
  { field: 'cc_resource_group', name: AdminSections.RESOURCE_GROUPS, route: RouteNames.RESOURCE_GROUPS },    // scope: cc_resource_group
  { field: 'cc_resource', name: AdminSections.RESOURCES, route: RouteNames.RESOURCES },               // scope: cc_resource
  ...
  { field: 'single_sign_on', name: AdminSections.SINGLE_SIGN_ON, route: RouteNames.SINGLE_SIGN_ON },
