...
const Agents = () =>
	import('../modules/agents/components/opened-queue-agents.vue');
const Buckets = () =>
	import('../modules/buckets/components/opened-queue-buckets.vue');
const Hooks = () =>
	import('../modules/hooks/components/opened-queue-hooks.vue');
const Logs = () => import('../modules/logs/components/opened-queue-logs.vue');
const Resources = () =>
	import('../modules/res-groups/components/opened-queue-resources.vue');
const Skills = () =>
	import('../modules/skills/components/opened-queue-skills.vue');
...
const MembersVariables = () =>
	import('../modules/members/components/opened-queue-member-variables.vue');
