<template>
  <section>
    ...
    <div class="object-input-grid">
      ...
      <wt-input :disabled="disableUserInput" :label="$t('objects.routing.dialplan.pattern')" :v="v.itemInstance.pattern"
        :value="itemInstance.pattern" required @input="setItemProp({ prop: 'pattern', value: $event })" />
