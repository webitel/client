					...
					itemInstance: {
						...
						metadata: {
							...
							version: {
								 ...
								 *
								 * Validates Meta Graph API version format: "vX.X", "vXX.X", "vXX.XX" (e.g., v1.0, v19.0, v24.0)
								 */
								valid: (value) =>
									!value || /^v([1-9]\d*)(\.(0|[1-9]\d*))$/.test(value),
							},
						},
					},
				};
	...
	computed: {
		...
		tabs() {
			...
			const webchatAppointment = {
				text: this.$t(
					'objects.routing.chatGateways.webchat.appointment.appointment',
				),
