...
const OpenedChatGatewayTelegramBotGeneralTab = () => import('../components/telegram-bot/opened-chat-gateway-telegram-bot-general-tab.vue');
const OpenedChatGatewayTelegramAppGeneralTab = () => import('../components/telegram-app/opened-chat-gateway-telegram-app-general-tab.vue');
const OpenedChatGatewayTemplatesTab = () => import('../components/_shared/opened-chat-gateway-templates-tab.vue');
const OpenedChatGatewayMessengerGeneralTab = () => import('../components/messenger/opened-chat-gateway-messenger-general-tab.vue');
const OpenedChatFacebook = () => import('../modules/messenger/facebook/components/facebook-tab.vue');
const OpenedChatInstagram = () => import('../modules/messenger/instagram/components/instagram-tab.vue');
const OpenedChatWhatsapp = () => import('../modules/messenger/whatsapp/components/whatsapp-tab.vue');
const OpenedChatGatewayInfobipGeneralTab = () => import('../components/infobip/opened-chat-gateway-infobip-general-tab.vue');
const OpenedChatGatewayViberGeneralTab = () => import('../components/viber/opened-chat-gateway-viber-general-tab.vue');
const OpenedChatGatewayWebchatGeneralTab = () => import('../modules/webchat/components/opened-chat-gateway-webchat-general-tab.vue');
const OpenedChatGatewayWebchatViewTab = () => import('../modules/webchat/components/opened-chat-gateway-webchat-view-tab.vue');
const OpenedChatGatewayWebchatAlternativeChannelsTab = () => import('../modules/webchat/components/opened-chat-gateway-webchat-alternative-channels-tab.vue');
const OpenedChatGatewayWebchatChatTab = () => import('../modules/webchat/components/opened-chat-gateway-webchat-chat-tab.vue');
