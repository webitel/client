...
const OpenedRegisterSipGatewayGeneral = () =>
	import('../components/opened-register-sip-gateway-general.vue');
const OpenedTrunkingSipGatewayGeneral = () =>
	import('../components/opened-trunking-sip-gateway-general.vue');
const OpenedTrunkingSipGatewayConfiguration = () =>
	import('../components/opened-trunking-sip-gateway-configuration.vue');
