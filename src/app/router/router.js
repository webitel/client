...
const PermissionsObjects = () =>
	import(
		"../../modules/permissions/modules/objects/components/the-objects-permissions.vue"
	);
const OpenedPermissionsObjects = () =>
	import(
		"../../modules/permissions/modules/objects/components/opened-object-permissions.vue"
	);
const Devices = () =>
...
const OpenedUser = () =>
	import("../../modules/directory/modules/users/components/opened-user.vue");
const License = () =>
	import("../../modules/directory/modules/license/components/the-license.vue");
const Blacklists = () =>
	import(
		"../../modules/lookups/modules/blacklists/components/the-blacklists.vue"
	);
const Media = () =>
	import("../../modules/lookups/modules/media/components/the-media.vue");
...
const CommunicationTypes = () =>
	import(
		"../../modules/lookups/modules/communications/components/the-communication-types.vue"
	);
const OpenedCommunicationType = () =>
	import(
		"../../modules/lookups/modules/communications/components/opened-communication-type.vue"
	);
const Regions = () =>
	import("../../modules/lookups/modules/regions/components/the-regions.vue");
const OpenedRegion = () =>
	import("../../modules/lookups/modules/regions/components/opened-region.vue");
const AgentPauseCause = () =>
	import(
		"../../modules/lookups/modules/agent-pause-cause/components/the-agent-pause-cause.vue"
	);
const OpenedAgentPauseCause = () =>
	import(
		"../../modules/lookups/modules/agent-pause-cause/components/opened-agent-pause-cause.vue"
	);
const SipGateways = () =>
	import(
		"../../modules/routing/modules/gateways/components/the-sip-gateways.vue"
	);
const OpenedGateway = () =>
	import(
		"../../modules/routing/modules/gateways/components/opened-sip-gateway.vue"
	);
const ChatGateways = () =>
	import(
		"../../modules/routing/modules/chat-gateways/components/the-chat-gateways.vue"
	);
const OpenedChatGateways = () =>
	import(
		"../../modules/routing/modules/chat-gateways/components/opened-chat-gateway.vue"
	);
const Flow = () =>
	import("../../modules/routing/modules/flow/components/the-flow.vue");
const OpenedFlow = () =>
	import("../../modules/routing/modules/flow/components/opened-flow.vue");
const Dialplan = () =>
	import("../../modules/routing/modules/dialplan/components/the-dialplan.vue");
const OpenedDialplan = () =>
	import(
		"../../modules/routing/modules/dialplan/components/opened-dialplan.vue"
	);
const Chatplan = () =>
	import("../../modules/routing/modules/chatplan/components/the-chatplan.vue");
const OpenedChatplan = () =>
	import(
		"../../modules/routing/modules/chatplan/components/opened-chatplan.vue"
	);
const TheResources = () =>
	import(
		"../../modules/contact-center/modules/resources/components/the-resources.vue"
	);
const OpenedResource = () =>
	import(
		"../../modules/contact-center/modules/resources/components/opened-resource.vue"
	);
const ResourceGroups = () =>
	import(
		"../../modules/contact-center/modules/resource-groups/components/the-resource-groups.vue"
	);
...
const Agents = () =>
	import(
		"../../modules/contact-center/modules/agents/components/the-agents.vue"
	);
const OpenedAgent = () =>
	import(
		"../../modules/contact-center/modules/agents/components/opened-agent.vue"
	);
const Teams = () =>
	import("../../modules/contact-center/modules/teams/components/the-teams.vue");
const OpenedTeam = () =>
	import(
		"../../modules/contact-center/modules/teams/components/opened-team.vue"
	);
const AgentSkills = () =>
	import(
		"../../modules/lookups/modules/agent-skills/components/the-agent-skills.vue"
	);
const OpenedAgentSkill = () =>
	import(
		"../../modules/lookups/modules/agent-skills/components/opened-agent-skill.vue"
	);
const Buckets = () =>
	import("../../modules/lookups/modules/buckets/components/the-buckets.vue");
const OpenedBucket = () =>
	import("../../modules/lookups/modules/buckets/components/opened-bucket.vue");
const Queues = () =>
	import(
		"../../modules/contact-center/modules/queues/components/the-queues.vue"
	);
const Members = () =>
	import(
...
const OpenedQueue = () =>
	import(
		"../../modules/contact-center/modules/queues/components/opened-queue.vue"
	);
const Storage = () =>
	import(
		"../../modules/integrations/modules/storage/components/the-storage.vue"
	);
const OpenedStorage = () =>
	import(
		"../../modules/integrations/modules/storage/components/opened-storage.vue"
	);
...
const EmailProfiles = () =>
	import(
		"../../modules/integrations/modules/email-profiles/components/the-email-profiles.vue"
	);
const SingleSignOn = () =>
	import(
		"../../modules/integrations/modules/single-sign-on/components/the-single-sign-on.vue"
	);
const ImportCsv = () =>
	import(
		"../../modules/integrations/modules/import-csv/components/the-import-csv.vue"
	);
const Triggers = () =>
	import(
		"../../modules/integrations/modules/triggers/components/the-triggers.vue"
	);
...
const OpenedEmailProfile = () =>
	import(
		"../../modules/integrations/modules/email-profiles/components/opened-email-profile.vue"
	);
const OpenedSingleSignOn = () =>
	import(
		"../../modules/integrations/modules/single-sign-on/components/opened-single-sign-on.vue"
	);
const OpenedImportCsv = () =>
	import(
		"../../modules/integrations/modules/import-csv/components/opened-import-csv.vue"
	);
const OpenedTrigger = () =>
	import(
		"../../modules/integrations/modules/triggers/components/opened-trigger.vue"
	);
const Changelogs = () =>
	import(
		"../../modules/system/modules/changelogs/components/the-changelogs.vue"
	);
const OpenedChangelog = () =>
	import(
		"../../modules/system/modules/changelogs/components/opened-changelog.vue"
	);
const Configuration = () =>
	import(
		"../../modules/system/modules/configuration/components/the-configuration.vue"
	);
const GlobalVariables = () =>
	import(
		"../../modules/system/modules/global-variables/components/the-global-variables.vue"
	);
