	...
	objects: {
		...
		directory: {
			...
			users: {
				...
				tokenPopupText:
					"Файлды қазір кілтпен жүктеп алыңыз немесе оны кейінірек пайдалану үшін көшіріңіз. Егер   файл кілтін қазір жүктемесеңіз,токен-кілтіңізді қайтадан ала алмайсыз. Сіздің қауіпсіздігіңіз үшін токен-кілтіңізді ешкімге бермеңіз.",
			...
			devices: {
				...
				searchPlaceholder:
					"Атауы, пайдаланушы, идентификатор & компьютер идентификаторы",
				...
				hotdeskInputHint:
					"Хост атауы үшін дұрыс таңбаларды пайдаланыңыз. Рұқсат етілген таңбалар: A-Z, a-z, 0-9, -, _",
				...
				passwordSetFromAccount:
					"Құпиясөзді орнатпасаңыз, ол аккаунтыңызбен бірдей болады",
			},
		},
		permissions: {
			permissions: "Рұқсат",
			...
			roles: {
				permissions: {
					...
					playbackRecordFileDescription:
						"Сөйлесу жазбалары бар файлдарды ойнатуға рұқсат береді",
					exportDataGridDescription: "Деректерді экспорттауға рұқсат береді",
					viewCdrPhoneNumbersDescription:
						"Шифрланбаған телефон нөмірлерін көрсетуге рұқсат береді",
					manageUserRolesDescription:
						"Пайдаланушы рөлдерінің жиынын басқаруға рұқсат береді",
					manageUserLicenseDescription:
						"Пайдаланушы лицензияларының жинағын басқаруға рұқсат береді",
					changeUserPasswordDescription:
						"Пайдаланушының құпиясөзін өзгертуге рұқсат береді",
				},
		...
		lookups: {
			...
			skills: {
				...
				minCapacityLessOrEqualToMaxCapacityValidator:
					"Ең жоғарғы әлеуеттен төмен немесе тең болуы керек",
				maxCapacity: "Ең жоғарғы әлеует",
				maxCapacityMoreOrEqualToMinCapacityValidator:
					"Ең төменгі әлеуеттен үлкен немесе тең болуы керек",
				lvl: "Деңгей",
		...
		routing: {
			...
			chatplan: {
				chatplan:
					"Мәтіндік хабарламаны бағыттау қағидасы | Мәтіндік хабарламаны бағыттау қағидасы",
			...
			chatGateways: {
				...
				webchat: {
					...
					copyCodeHint:
						"Баптауды әр өзгерткеннен кейін сайтқа Виджет кодын қайта жасау және енгізу қажет",
					metadata: {
					...
					appointment: {
						...
						showDefaultHeading:
							"Нәтиже бетінде стандартты тақырып пен тақырыпшаны көрсетіңіз",
					},
					alternativeChannels: {
		...
		ccenter: {
			...
			members: {
				...
				resetMembers: {
					...
					description:
						"Сіз шынымен абоненттердің сәтсіз әрекеттері бойынша қайта қоңырау шалғыңыз келе ме? ",
					reset: "Қайтадан қосу",
			...
			queues: {
				...
				outboundIVRQueueDescription:
					"Шығыс IVR ұйымға жеке хабарландыруларды қолдана отырып, автоматты дыбыстық қоңыраулар, SMS хабарламалар, электрондық пошта немесе әлеуметтік желілердегі хабарламалар сияқты бірнеше арна арқылы клиенттерді автоматты түрде тартуға мүмкіндік береді.",
				inboundQueue: "Кіріс кезегі",
				inboundQueueDescription:
					"Кіріс кезегі: Қоңырау шалушылар оператормен сөйлесу үшін кезекте күтеді.",
				offlineQueue: "Оффлайн кезек",
				offlineQueueDescription:
					"Автономды кезек қоңырау шалушыларға күтуді тоқтатуға, телефон нөмірін енгізуге және кері қоңырау шалуға мүмкіндік береді.",
				...
				maxAgentLose:
					"Желілер терілгенге дейін тоқтату үшін қабылданбаған қоңыраулардың ең көп саны",
		...
		integrations: {
			...
			importCsv: {
				importCsv:
					"CSV файлынан деректерді импорттау | CSV файлдарынан деректерді импорттау",
				allImportsCsv: "CSV файлдарынан импортталған барлық деректер ",
				source: "Импорттауды тағайындау",
				settings: "Баптау",
				mappings: "Өрістер маппингі",
				mappingsHint:
					"Бұл бөлімде CSV файлының бағандарының атауларын төменгі өрістерде олардың тақырыптарына сәйкес көрсету қажет",
				columnHeader: "Баған",
				members: {
			...
			tokens: {
				...
				popupMessage:
					"Кілт файлын жүктеп алыңыз немесе оны көшіріп алыңыз. Кілт файлын қазір жүктеп алмасаңыз, оны қайтадан шығарып ала алмайсыз. Қауіпсіздікті арттыру үшін кілтті қауіпсіз жерде сақтаңыз және оны ешкімге бермеңіз",
