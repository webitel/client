...
export default {
  ...
  objects: {
    ...
    directory: {
      directory: 'Каталог',
      passwordInfo: 'Введите значение только если хотите его перезаписать (или задать новое)',
      users: {
    ...
    permissions: {
      ...
      roles: {
        permissions: {
          ...
          schemeVariablesDescription: 'Предоставляет разрешение на управление разделом Глобальные переменные',
        },
