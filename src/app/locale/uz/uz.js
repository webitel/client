  ...
  objects: {
    ...
    routing: {
      ...
      flow: {
        ...
        diagram: {
          diagram: 'Diagramma',
          description: 'Yangi flowni Webitel Flow Diagramm toolidan foydalanish orqali yaratish',
        },
        code: {
          code: 'Kod',
          description: 'Yangi flowni JSON-sxemasi kodi tahrirlash orqali yaratish',
        },
        askingAlert: 'Siz "{name}" ga tayyorlagan o\'zgarishlarni saqlashni xohlaysizmi?',
      },
      ...
      chatGateways: {
        ...
        webchat: {
          ...
          view: {
            ...
            logoUrl: 'Logo URL',
            logoHint: "Qo'llab-quvvatlangan logo formati 'JPEG' yoki 'PNG', 24x24px",
            rounded: 'Yaxlit',
            square: 'To\'rtburchak',
            right: 'O\'ng',
            left: 'Chap',
    ...
    ccenter: {
      ...
      queues: {
        ...
        minOnlineAgents:
          'Pausaga kirish uchun mavjud agentlar soni ko\'ra',
    ...
    system: {
      ...
      globalVariables: {
        ...
        valueInfo: 'Qiymatni o\'zgartirmoqchi bo\'lsangiz, bo\'sh maydonga qo\'ying',
